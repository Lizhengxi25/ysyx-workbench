...
#endif
                VL_FATAL_MT("ram.v", 2, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vram___024root___dump_triggers__ico(Vram___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vram__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vram___024root___dump_triggers__ico\n"); );
    // Body
...
VL_ATTR_COLD void Vram___024root___ctor_var_reset(Vram___024root* vlSelf) {
    ...
    vlSelf->addrin = VL_RAND_RESET_I(3);
    vlSelf->addrout = VL_RAND_RESET_I(3);
    vlSelf->dout = VL_RAND_RESET_I(8);
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->ram__DOT__ram[__Vi0] = VL_RAND_RESET_I(8);
    }
